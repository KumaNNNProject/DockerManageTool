...
{		
	echo
	echo -e "\033[1;37mDocker Management Tool\033[0m"
	echo " 		Local host docker management tool"
	echo -e "\033[1;37m Author:\033[0m KumaNNN"
	echo -e "\033[1;37mProject:\033[0m https://github.com/KumaNNNProject/DM_ShellTool"
	echo
	echo
	echo -e "\033[1;37mDocker管理工具\033[0m"
	echo " 		本地主机Docker管理工具"
	echo -e "\033[1;37m作者:\033[0m KumaNNN"
	echo -e "\033[1;37m项目:\033[0m https://github.com/KumaNNNProject/DM_ShellTool"
	echo

}

# ================================================== 
# 函数名称: DockerManagement_Init		 					  	 
# 函数功能: Docker管理工具初始化	  							 
# 函数参数: 			 		 	  				 
#     		 $1:   执行的命令				      	 
#     	   [$2]:   执行成功时回调			      	 
...
# 		${Var}: 其它							  
# ================================================== 
function DockerManagement_Init()
{		
	# ----[文件加载]-------------------------------------------------------
	# 第三方库
	FUN_Source "funlist/lib/ip/ip.funlist"
	FUN_Source "funlist/lib/ByteConvert/ByteConvert.funlist"
	FUN_Source "funlist/lib/RepeatStr/RepeatStr.funlist"
	FUN_Source "funlist/lib/DockerInfo/Docker.info.funlist"
	FUN_Source "funlist/lib/SysInfo/sysinfo.sh"
	# 核心库
	FUN_Source "funlist/dm.Init.funlist"
	FUN_Source "funlist/dm.Helpers.funlist"
	FUN_Source "funlist/dm.Infos.funlist"
	FUN_Source "funlist/dm.Show.funlist"
	FUN_Source "funlist/dm.Action.funlist"
	# 菜单
	FUN_Source "funlist/Menu/Menu.funlist"
	FUN_Source "funlist/Menu/Menu.Dashboard.funlist"
	FUN_Source "funlist/Menu/Menu.Main.funlist"
	FUN_Source "funlist/Menu/Menu.Images.funlist"
	FUN_Source "funlist/Menu/Menu.Containers.funlist"
	FUN_Source "funlist/Menu/Menu.Networks.funlist"
	FUN_Source "funlist/Menu/Menu.Volumes.funlist"
	FUN_Source "funlist/Menu/Menu.Searchs.funlist"
	FUN_Source "funlist/Menu/Menu.Others.funlist"
	echo  'File source complete...'
	MAP_SET 1	
	echo  'MAP_SET complete...'
	# ----[文件加载]-------------------------------------------------------
	# ----[执行流程]-------------------------------------------------------
	Init_Conf
	Init_FileDir
...
if [ "${1,,}" == '--help' ]; then
   ...
   DockerManagement_Init  "$1"  "$2"  "$3"  "$4"  "$5"  "$6"  "$7"  "$8"  "$9"
fi
